...
**Paw paws litle house** сервіс для прихисту лапок з хатинки

## Можливості

- Подивитися перелік всих хвостиків
- Переглянути детальну інформацію про хвостика
- Замовити знайомство з хвостиком
- Переглянути історію хатинки
- Перглянути щасливі історії про хвостиків, що знайшли дім
...
Для запуску сайту потрібно [Node.js](https://nodejs.org/) v10+.

Встановіть залежності та запустіть сервер.

```sh
cd paw-paw-litle-house
npm install
npm run dev
```

Перевірте роботу хатинки переходячи за посиланням на ваш сервер у вашому
олюбленому браузері.
